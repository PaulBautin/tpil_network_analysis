...
def disruption_index_combined(df_metric_con, df_metric_clbp, df_degree_con):
    ...
    """
    # loc_deg_clbp = pd.read_csv('/Users/Marc-Antoine/Documents/tpil_network_analysis/results/friedman/local/degree_clbp.csv')
    # loc_deg_clbp = loc_deg_clbp['statistic'].reset_index()
    # loc_deg_clbp['Condition'] = 1
    # loc_deg_clbp['Metric'] = 1
    # loc_str_clbp = pd.read_csv('/Users/Marc-Antoine/Documents/tpil_network_analysis/results/friedman/local/strength_clbp.csv')
    # loc_str_clbp = loc_str_clbp['statistic'].reset_index()
    # loc_str_clbp['Condition'] = 1
    # loc_str_clbp['Metric'] = 2
    # loc_bet_clbp = pd.read_csv('/Users/Marc-Antoine/Documents/tpil_network_analysis/results/friedman/local/betweenness_clbp.csv')
    # loc_bet_clbp = loc_bet_clbp['statistic'].reset_index()
    # loc_bet_clbp['Condition'] = 1
    # loc_bet_clbp['Metric'] = 3
    # loc_clu_clbp = pd.read_csv('/Users/Marc-Antoine/Documents/tpil_network_analysis/results/friedman/local/cluster_clbp.csv')
    # loc_clu_clbp = loc_clu_clbp['statistic'].reset_index()
    # loc_clu_clbp['Condition'] = 1
    # loc_clu_clbp['Metric'] = 4
    # loc_eff_clbp = pd.read_csv('/Users/Marc-Antoine/Documents/tpil_network_analysis/results/friedman/local/efficiency_clbp.csv')
    # loc_eff_clbp = loc_eff_clbp['statistic'].reset_index()
    # loc_eff_clbp['Condition'] = 1
    # loc_eff_clbp['Metric'] = 5

    # loc_deg_con = pd.read_csv('/Users/Marc-Antoine/Documents/tpil_network_analysis/results/friedman/local/degree_con.csv')
    # loc_deg_con = loc_deg_con['statistic'].reset_index()
    # loc_deg_con['Condition'] = 2
    # loc_deg_con['Metric'] = 1
    # loc_str_con = pd.read_csv('/Users/Marc-Antoine/Documents/tpil_network_analysis/results/friedman/local/strength_con.csv')
    # loc_str_con = loc_str_con['statistic'].reset_index()
    # loc_str_con['Condition'] = 2
    # loc_str_con['Metric'] = 2
    # loc_bet_con = pd.read_csv('/Users/Marc-Antoine/Documents/tpil_network_analysis/results/friedman/local/betweenness_con.csv')
    # loc_bet_con = loc_bet_con['statistic'].reset_index()
    # loc_bet_con['Condition'] = 2
    # loc_bet_con['Metric'] = 3
    # loc_clu_con = pd.read_csv('/Users/Marc-Antoine/Documents/tpil_network_analysis/results/friedman/local/cluster_con.csv')
    # loc_clu_con = loc_clu_con['statistic'].reset_index()
    # loc_clu_con['Condition'] = 2
    # loc_clu_con['Metric'] = 4
    # loc_eff_con = pd.read_csv('/Users/Marc-Antoine/Documents/tpil_network_analysis/results/friedman/local/efficiency_con.csv')
    # loc_eff_con = loc_eff_con['statistic'].reset_index()
    # loc_eff_con['Condition'] = 2
    # loc_eff_con['Metric'] = 5
    ...
    # # Update layout to adjust spacing between categories and ticks on z-axis
    # fig.update_layout(scene=dict(zaxis=dict(tickmode='linear', tick0=0, dtick=1)))
    # fig.update_layout(scene=dict(xaxis=dict(tickmode='linear', tick0=0, dtick=1)))
    # fig.update_layout(scene=dict(aspectmode='manual', aspectratio=dict(x=1.5, y=0.50, z=1)))
    # # Add a line to highlight significance at z=6
    # fig.add_scatter3d(x=['DC local', 'SC local', 'BC local', 'CC local', 'E local',
    #                      'DC limbic', 'SC limbic', 'BC limbic', 'CC limbic', 'E limbic',
    #                      'SW global', 'SC global', 'M global', 'CC global', 'E global'], 
    #                 y=['CLBP', 'CLBP', 'CLBP', 'CLBP', 'CLBP', 'CLBP',
    #                    'CLBP', 'CLBP', 'CLBP', 'CLBP', 'CLBP', 'CLBP',
    #                    'CLBP', 'CLBP', 'CLBP', 'CLBP', 'CLBP', 'CLBP'], 
