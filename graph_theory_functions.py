...
def networkx_graph_convertor(df_connectivity_matrix, df_weighted_nodes):
    ...
    print(node_color)
    nx.draw_networkx(G, pos=dict_coords, labels=dict_labels, node_color=node_color['centrality'], cmap=colormap, vmin=-2, vmax=2, with_labels=False) #for z-score, add vmin=-2,vmax=2
    #set colorbar
